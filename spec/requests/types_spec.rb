...
RSpec.describe '/types', type: :request do
  ...
  let(:valid_attributes) do
    { label: Faker::Lorem.word, description: Faker::Lorem.sentence, subject: Faker::Lorem.word,
      prayer_duration: Faker::Number.positive.to_i, topic_id: topic.id, tag_id: tag.id }
  end
